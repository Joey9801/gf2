...
\section{File format}
    ...
    \subsection{Possible syntax errors}
	    The table below gives some examples of syntax errors which will have to be safely handled by the programme. All syntax errors will be unrecoverable, and hence the user will have to be informed of the error.
